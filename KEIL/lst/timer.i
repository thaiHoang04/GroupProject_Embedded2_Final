...
# 9 "Library/StdDriver/src/timer.c" 2
# 41 "Library/StdDriver/src/timer.c"
uint32_t TIMER_Open(TIMER_T *timer, uint32_t u32Mode, uint32_t u32Freq)
{
...
# 74 "Library/StdDriver/src/timer.c"
void TIMER_Close(TIMER_T *timer)
{
    timer->CTL = 0UL;
    timer->EXTCTL = 0UL;
}
# 94 "Library/StdDriver/src/timer.c"
int32_t TIMER_Delay(TIMER_T *timer, uint32_t u32Usec)
{
    uint32_t u32Clk = TIMER_GetModuleClock(timer);
...
# 195 "Library/StdDriver/src/timer.c"
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~((0x1ul << (4)) | (0x7ul << (12)))) |
                    u32CapMode | u32Edge | (0x1ul << (3));
}
# 210 "Library/StdDriver/src/timer.c"
void TIMER_DisableCapture(TIMER_T *timer)
{
    timer->EXTCTL &= ~(0x1ul << (3));
}
# 229 "Library/StdDriver/src/timer.c"
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~(0x1ul << (0))) | u32Edge;
    timer->CTL |= (0x1ul << (24));
}
# 244 "Library/StdDriver/src/timer.c"
void TIMER_DisableEventCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (24));
}
# 259 "Library/StdDriver/src/timer.c"
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
...
# 315 "Library/StdDriver/src/timer.c"
void TIMER_EnableFreqCounter(TIMER_T *timer,
                             uint32_t u32DropCount,
                             uint32_t u32Timeout,
                             uint32_t u32EnableInt)
...
# 349 "Library/StdDriver/src/timer.c"
void TIMER_SetTriggerSource(TIMER_T *timer, uint32_t u32Src)
{
    timer->TRGCTL = (timer->TRGCTL & ~(0x1ul << (0))) | u32Src;
}
# 364 "Library/StdDriver/src/timer.c"
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
