...
# 55 "Library/StdDriver/src/clk.c"
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
...
# 74 "Library/StdDriver/src/clk.c"
void CLK_PowerDown(void)
{
...
# 145 "Library/StdDriver/src/clk.c"
uint32_t CLK_GetLXTFreq(void)
{
    uint32_t u32Freq;
...
# 206 "Library/StdDriver/src/clk.c"
uint32_t CLK_GetPCLK1Freq(void)
{
    uint32_t u32Freq;
    SystemCoreClockUpdate();
...
# 246 "Library/StdDriver/src/clk.c"
uint32_t CLK_GetHCLKFreq(void)
{
    SystemCoreClockUpdate();
...
# 273 "Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    uint32_t u32HIRCSTB;
...
# 335 "Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    uint32_t u32HIRCSTB;
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if((((u32ModuleIdx) >>10) & 0xffUL) != 0x0UL)
    {
        ...
        if ((((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->CSERVER & (0xfful << (0))) == 0x1) // M480LD
        {
            if((((u32ModuleIdx) >>18) & 0x3UL) == 2U && (((u32ModuleIdx) & 0x1fUL) << 0) == 31U) //((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x0B000UL))
            {
                u32div = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV2;
            }
            else if((((u32ModuleIdx) >>18) & 0x3UL) == 2U && (((u32ModuleIdx) & 0x1fUL) << 0) == 29U) //((I2S_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x08000UL))
            {
                u32div = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV2;
            }
...
# 770 "Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    uint32_t u32tmpVal = 0UL, u32tmpAddr = 0UL;
...
# 792 "Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
...
# 949 "Library/StdDriver/src/clk.c"
void CLK_DisablePLL(void)
{
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL |= (0x1ul << (16));
}
# 968 "Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 1003 "Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
# 1055 "Library/StdDriver/src/clk.c"
void CLK_SetPowerDownMode(uint32_t u32PDMode)
{
    if ((((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->CSERVER & (0xfful << (0))) == 0x1) // M480LD
    {
...
# 1111 "Library/StdDriver/src/clk.c"
void CLK_EnableDPDWKPin(uint32_t u32TriggerType)
{
    ...
    if ((((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->CSERVER & (0xfful << (0))) == 0x1) // M480LD
    {
        ...
        u32Pin4 = ((u32TriggerType) & (0x3ul << (30)));
...
# 1159 "Library/StdDriver/src/clk.c"
uint32_t CLK_GetPMUWKSrc(void)
{
    return (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PMUSTS);
}
# 1180 "Library/StdDriver/src/clk.c"
void CLK_EnableSPDWKPin(uint32_t u32Port, uint32_t u32Pin, uint32_t u32TriggerType, uint32_t u32DebounceEn)
{
...
# 1287 "Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    uint32_t u32sel = 0;
...
# 1336 "Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32div = 0;
    ...
    if((((u32ModuleIdx) >>10) & 0xffUL) != 0x0UL)
    {
        ...
        if ((((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->CSERVER & (0xfful << (0))) == 0x1) // M480LD
        {
            if((((u32ModuleIdx) & 0x1fUL) << 0) == 31U) //((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x0B000UL))
                u32div = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV2;
            else if((((u32ModuleIdx) & 0x1fUL) << 0) == 29U) //((I2S_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x08000UL))
                u32div = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV2;
        }
