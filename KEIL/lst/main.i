...
# 12 "../main.c" 2
# 1 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 1 3
# 82 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 3
...
# 127 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 3
...
# 156 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 3
extern __attribute__((__nothrow__)) time_t time(time_t * );
# 166 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 3
...
# 178 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 3
...
# 203 "C:\\Users\\binbu\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\time.h" 3
...
void TMR0_IRQHandler(void) {
    ...
    ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL))->INTSTS |= (1 << 0);
}
# 74 "../main.c"
int32_t main(void)
{
 ...
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->LINE &= ~(1 << 2); // One stop bit
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->LINE &= ~(1 << 3); // No parity bit
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO |= (1 << 1); // Clear RX FIFO
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO |= (1 << 2); // Clear TX FIFO
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO &= ~(0xF << 16); // FIFO Trigger level is 1 byte

 // Baud rate config: Mode 0 - 115200 bps
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD &= ~(0b11 << 28); // mode 0
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD &= ~(0xFFFF << 0); // Clear the current baud rate divisor value
 ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD |= 4; //Divisor is equal 4 to generate the baud rate = 115200


    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 &= ~((0xF << 0) | (1 << 4) | (0b111 << 8) // Clear the current setting in ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) Bank0.
                    | (0b111 << 16) | (1 << 24));
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= (1 << 1); // Set the ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) data width to 16-bit.
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= (0b001 << 8); // Set the external output clock divider to HCLK / 2 (001).
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 &= ~(1 << 2); // Select the active low chip pin.
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= (1 << 0); // Enable ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) function/
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= (3 << 16); // Set the extend time of ALE.
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= (1 << 4); // Enable the continous data access mode.
    ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0 |= ((1 << 23) | (1 << 22)); // Disable the data access hold time during ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) writing and reading.
    ...
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->MODE &= ~((0x03 << 12) | (0x03 << 14)); // clear settings for ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)).6 and ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)).7
 ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->MODE |= ((0x01 << 12) | (0x01 << 14)); // Set output push-pull mode for ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)).6 and ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)).7
    ...
    ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->CTL &= ~(1 << 8); // Set the single end analog input mode.
