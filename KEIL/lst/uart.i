...
# 89 "Library/StdDriver/src/uart.c"
void UART_Close(UART_T* uart)
{
    uart->INTEN = 0ul;
}
...
# 144 "Library/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T* uart)
{
...
# 175 "Library/StdDriver/src/uart.c"
void UART_EnableInt(UART_T* uart, uint32_t u32InterruptFlag)
{

    ((uart)->INTEN |= (u32InterruptFlag));
}
# 192 "Library/StdDriver/src/uart.c"
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    else if((uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x36000UL))) && ((((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->CSERVER & (0xfful << (0))) == 0x1)) // M480LD
    {

        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (20))) >> (20);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV4 & (0xful << (16))) >> (16);
    }
    else if((uart==(UART_T*)((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x37000UL))) && ((((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->CSERVER & (0xfful << (0))) == 0x1)) // M480LD
    {

        u32UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL3 & (0x3ul << (22))) >> (22);

        u32UartClkDivNum = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV4 & (0xful << (20))) >> (20);
    }
...
# 362 "Library/StdDriver/src/uart.c"
void UART_SetLineConfig(UART_T* uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
    uint32_t u32UartClkSrcSel=0ul, u32UartClkDivNum=0ul;
...
# 465 "Library/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T* uart, uint32_t u32TOC)
{
...
# 488 "Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    uint32_t u32UartClkSrcSel=0ul, u32UartClkDivNum=0ul;
    uint32_t u32ClkTbl[4ul] = {(12000000UL), 0ul, (32768UL), (12000000UL)};
...
# 607 "Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T* uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 631 "Library/StdDriver/src/uart.c"
void UART_SelectLINMode(UART_T* uart, uint32_t u32Mode, uint32_t u32BreakLength)
{
...
# 653 "Library/StdDriver/src/uart.c"
uint32_t UART_Write(UART_T* uart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    uint32_t u32Count, u32delayno;
    uint32_t u32Exit = 0ul;
