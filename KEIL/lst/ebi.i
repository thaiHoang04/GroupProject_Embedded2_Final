...
# 10 "Library/StdDriver/src/ebi.c" 2
# 56 "Library/StdDriver/src/ebi.c"
void EBI_Open(uint32_t u32Bank, uint32_t u32DataWidth, uint32_t u32TimingClass, uint32_t u32BusMode, uint32_t u32CSActiveLevel)
{
    uint32_t u32Index0 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 + (uint32_t)u32Bank * 0x10U;
    uint32_t u32Index1 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0 + (uint32_t)u32Bank * 0x10U;
...
# 148 "Library/StdDriver/src/ebi.c"
void EBI_Close(uint32_t u32Bank)
{
    uint32_t u32Index = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 + u32Bank * 0x10U;
    volatile uint32_t *pu32EBICTL = (uint32_t *)( u32Index );

    *pu32EBICTL &= ~(0x1ul << (0));
}
# 178 "Library/StdDriver/src/ebi.c"
void EBI_SetBusTiming(uint32_t u32Bank, uint32_t u32TimingConfig, uint32_t u32MclkDiv)
{
    uint32_t u32Index0 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 + (uint32_t)u32Bank * 0x10U;
    uint32_t u32Index1 = (uint32_t)&((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0 + (uint32_t)u32Bank * 0x10U;
