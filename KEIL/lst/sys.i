...
# 10 "Library/StdDriver/src/sys.c"
...
# 11 "Library/StdDriver/src/sys.c" 2
# 44 "Library/StdDriver/src/sys.c"
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->RSTSTS |= u32Src;
}
# 56 "Library/StdDriver/src/sys.c"
uint32_t SYS_GetBODStatus(void)
{
...
# 79 "Library/StdDriver/src/sys.c"
uint32_t SYS_IsRegLocked(void)
{
...
# 216 "Library/StdDriver/src/sys.c"
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
