# 1 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 400 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c" 2
# 10 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c"
...
# 11 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c" 2
...
# 13 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c" 2
# 36 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c"
int32_t TRNG_Open(void)
{
    int32_t tout = SystemCoreClock;

    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 |= (0x1ul << (31));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 ^= (0x1ul << (31));

    ((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->ACT |= (0x1ul << (7));


    while ((tout-- > 0) && !(((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->CTL & (0x1ul << (7))))
    {
    }
    if (tout <= 0)
        return -1;

    ((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->CTL |= (0x1ul << (0));
    return 0;
}
# 65 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c"
int32_t TRNG_GenWord(uint32_t *u32RndNum)
{
    uint32_t i, u32Reg, timeout;

    *u32RndNum = 0;
    u32Reg = ((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->CTL;

    for (i = 0; i < 4; i++)
    {
        ((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->CTL = (0x1ul << (0)) | u32Reg;


        for (timeout = (CLK_GetHCLKFreq() / 100); timeout > 0; timeout--)
        {
            if (((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->CTL & (0x1ul << (1)))
                break;
        }
        ...
        *u32RndNum |= ((((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->DATA & 0xff) << i*8);

    }
    return 0;
}
# 101 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c"
int32_t TRNG_GenBignum(uint8_t u8BigNum[], int32_t i32Len)
{
    uint32_t i, u32Reg, timeout;
    ...
    for (i = 0; i < i32Len/8; i++)
    {
        ...
        u8BigNum[i] = (((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->DATA & 0xff);
    }
    return 0;
}
# 135 "../../../EEET2481_Tutorial_1_LED_Sweep/EEET2481_Tutorial_1_LED_Sweep/Library/StdDriver/src/trng.c"
int32_t TRNG_GenBignumHex(char cBigNumHex[], int32_t i32Len)
{
    ...
    for (i = 0; i < i32Len/8; i++)
    {
        ...
        data = (((TRNG_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x79000UL))->DATA & 0xff);
